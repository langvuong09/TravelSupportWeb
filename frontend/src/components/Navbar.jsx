...
const PUBLIC_NAV = [
  ...
  { path: "/tours",      label: "Tours",     icon: <Ic.Tour /> },
];
...
const USER_NAV = [
  ...
  { path: "/locations",    label: "Địa điểm",   icon: <Ic.Map /> },
  { path: "/tours",        label: "Tours",      icon: <Ic.Tour /> },
  { path: "/my-bookings",  label: "Đặt tour",   icon: <Ic.Bookmark /> },
          ...
          {!user ? (
            ...
            <div className="user-menu">
              <button className="user-trigger" onClick={() => setMenuOpen(!menuOpen)}>
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14" style={{ transform: menuOpen ? "rotate(180deg)" : "", transition: "0.2s" }}>
